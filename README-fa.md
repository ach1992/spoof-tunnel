...
چی‌شد که ایده اسپوف تانل دو طرفه به ذهنم رسید؟
بعد از قیام خونین 18 و 19 دی که اینترنت های ایران به طور کامل قطع شد و وارد یه بلک اوت بزرگ شدیم
سعی می‌کردیم ببینیم محدودیت دقیقا در چه سطح و لایه ای اعمال شده

اومدیم و bgp رنج آیپی های ایران رو دیدیم، دیدیم در کمال تعجب، برخلاف قطعی اینترنت افغانستان که bgp رنج آیپی ها افتاده بود، رنج های ایرانی bgp داشتن، پس به این نتیجه رسیدیم زیرساخت بین الملل ممکنه وجود داشته باشه هنوز

بعد از اون متوجه شدیم که یک سری از شرکت های ایرانی متصل به حکومت تونستن آیپی های خودشونو بذارن داخل وایت لیست، که در نتیجه اش اینترنت بین الملل داشتن
پس این نظریه ایجاد شد که محدودیت لایه3 هست و روی srcIP , dstIP 
بعد از این هم متوجه شدیم که یک سری از آیپی های خارجی، مثلا از هتزنر به ایران دسترسی دارن

پس این نظریه کاملا پذیرفته شد که محدودیت لایه3 روی فایروال هست، نه قطعی واقعی

پس در این شرایط ایده اسپوف تانل به ذهنم رسید، همونطور که میدونید وقتی یک پکت اسپوف به یک سرور ارسال بشه، بصورت دیفالت اون سرور باید پکت رو به آیپی اسپوف برگردونه،‌ نه هاستی که واقعا پکت ازش ارسال شده

پس نیاز بود که یک اسپوف دو طرفه داشته باشیم، همینطور کلاینت و سرور باید از قبل از آیپی هم دیگه اطلاع میداشتن تا بتونن کانکشن رو برقرار کنن.
